        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-stretch">
          ...
          <div className="lg:col-span-7 glass-panel rounded-3xl p-8 border border-white/10 flex flex-col justify-between space-y-6">
            <div className="space-y-4">
              ...
              <p className="text-slate-300 leading-relaxed">
                Whether it's building interactive course viewers like <span className="text-blue-300 font-mono">CourseFlix</span>, test analytics dashboards like <span className="text-purple-300 font-mono">TestFlix Pro</span>, or lightweight media platforms like <span className="text-emerald-300 font-mono">SoftPix</span>, I take pride in delivering production-ready, clean, and user-centric software.
              </p>
            </div>
          ...
          <div className="lg:col-span-5 glass-card rounded-3xl p-8 border border-purple-500/30 bg-gradient-to-b from-purple-950/20 to-slate-950/60 flex flex-col justify-between space-y-6 relative overflow-hidden group">
            ...
            <div className="space-y-4">
              <div className="w-12 h-12 rounded-2xl bg-purple-600/20 border border-purple-400/40 flex items-center justify-center text-purple-300">
                <Award className="w-6 h-6" />
              </div>

              <div>
                <span className="text-xs font-mono text-purple-400 uppercase tracking-widest">Next Destination</span>
                <h4 className="text-3xl font-extrabold text-white mt-1">
                  IIT Bombay Goal 🏛️
                </h4>
                <p className="text-xs text-purple-300 font-medium mt-1">GATE Preparation (2026–2027)</p>
              </div>

              <p className="text-sm text-slate-300 leading-relaxed">
                Currently dedicating rigorous preparation for <span className="text-white font-semibold">GATE CS</span> to secure a Master's at <span className="text-purple-300 font-semibold">IIT Bombay</span>. My objective is to dive deeper into Advanced Systems Architecture, Distributed Cloud Systems, and Scalable Infrastructure Engineering.
              </p>
            </div>
            ...
            <div className="glass-panel p-4 rounded-2xl border border-white/10 space-y-2">
              <div className="flex justify-between text-xs font-mono">
                ...
                <span className="text-purple-300 font-bold">2026 – 2027</span>
              </div>
              <div className="w-full h-2 rounded-full bg-white/10 overflow-hidden">
                <div className="h-full bg-gradient-to-r from-blue-500 via-indigo-500 to-purple-500 w-3/4 rounded-full animate-pulse"></div>
              </div>
            </div>
        ...
        <div className="space-y-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {strengths.map((item, index) => (
              <div
                key={index}
                className="glass-card rounded-2xl p-6 border border-white/10 hover:border-blue-400/30 transition-all duration-300 flex flex-col justify-between space-y-4"
              >
