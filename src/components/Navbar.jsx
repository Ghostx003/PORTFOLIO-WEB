  ...
  return (
    <header className="fixed top-0 left-0 right-0 z-50 px-4 sm:px-8 py-4 transition-all duration-300">
      <div className={`max-w-7xl mx-auto rounded-2xl transition-all duration-300 ${
        scrolled ? 'glass-navbar py-3 px-6 shadow-2xl shadow-emerald-950/20' : 'bg-transparent py-2 px-4'
      }`}>
        <div className="flex items-center justify-between">
          {/* Brand Logo */}
          <a href="#home" className="flex items-center gap-2 group">
            <div className="w-10 h-10 rounded-xl bg-gradient-to-tr from-cyan-600 via-teal-500 to-emerald-500 flex items-center justify-center font-bold text-lg text-white shadow-lg shadow-teal-500/25 group-hover:scale-105 transition-transform duration-300">
              DN
            </div>
            <div className="flex flex-col">
              <span className="font-bold tracking-wider text-base text-white group-hover:text-teal-300 transition-colors">
                DEVI NAYAK
              </span>
              ...
              <a
                ...
                className={`px-4 py-1.5 rounded-full text-sm font-medium transition-all duration-300 relative ${
                  activeSection === link.id
                    ? 'text-white bg-teal-600/30 border border-teal-400/40 shadow-inner'
          ...
          <div className="hidden lg:flex items-center gap-3">
            ...
            <a
              href="#contact"
              className="flex items-center gap-2 px-4 py-2 text-xs font-semibold text-white bg-gradient-to-r from-cyan-600 via-teal-600 to-emerald-600 hover:from-cyan-500 hover:to-emerald-500 rounded-xl shadow-lg shadow-teal-500/20 transition-all hover:scale-105"
            >
          ...
          <div className="flex flex-col gap-3">
            ...
            <div className="pt-4 border-t border-white/10 flex flex-col gap-3">
              ...
              <a
                href="#contact"
                onClick={() => setMobileMenuOpen(false)}
                className="w-full flex items-center justify-center gap-2 px-4 py-3 text-sm font-semibold text-white bg-gradient-to-r from-cyan-600 via-teal-600 to-emerald-600 rounded-xl"
              >
                <Send className="w-4 h-4" />
                Get In Touch
              </a>
